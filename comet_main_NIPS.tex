...
\begin{table*}[t]
\caption{Asymptotic computational complexity per data pass of COMET, SGD based methods \citep{OASIS, qian}, HDSL \c . $T$ is the number of triplets, $d$ is the dimension, $0<\gamma \leq 1$ is the data sparsity, and $P$ is the frequenct of PSD projections for the SGD based methods}
\label{comp-complx}
\vskip 0.15in
\begin{center}
\begin{small}
